...
public class charubfs4
{
 ...
 int clustid = 1;
    ...
    {
        new charubfs4(); // I like doing things this way so I don't have to use static objects
    }

    charubfs4() throws FileNotFoundException
    {
...
//        
    ...
    {
	System.err.println("Calling BFS(params)");
